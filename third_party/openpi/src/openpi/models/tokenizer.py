...
class FASTTokenizer:
    def __init__(self, max_len: int = 256, fast_tokenizer_path: str = "/seu_share/home/dishimin/230259982/.cache/huggingface/hub/models--physical-intelligence--fast/snapshots/ec4d7aa71691cac0b8bed6942be45684db2110f4"):
        self._max_len = max_len
